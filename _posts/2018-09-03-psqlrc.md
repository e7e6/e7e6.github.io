...
As a whole, it might be a useful tool to know, especially if you often connect to the same server(s). Here are a few examples of what can be changed:
